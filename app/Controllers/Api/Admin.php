...
class Admin extends ResourceController
{
    ...
    public function index()
    {
        if($this->request->isAJAX()){
            return DataTables::use('users')->orWhere(['auth_groups.name'=>'admin'])->orWhere(['auth_groups.name'=>'super admin'])
                    ...
                    <div class='input-group'>
                        <span class='input-group-btn'>
                            ...
                            <div class='dropdown-menu'>
                                ...
                                <button class='dropdown-item cpass' onclick='changePassword(this, $data->admin_id)' data-toggle='modal' data-target='#modelId'>
                                    <span class='fas fa-key'>
                                    </span>
                                    Change Password
                                </button>
                                <div role='separator' class='dropdown-divider'></div>
                                <button class='dropdown-item delete' onclick='deleteCurrentRow(this, $data->admin_id)' data-type='Admin'>
